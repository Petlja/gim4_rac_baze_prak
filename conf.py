...
project = 'SQL практикум за четврти разред гимназије'
...
html_context = {'course_id': 'SQL_Praktikum',
...
html_theme_options = {
    ...
    'navbar_title': "SQL практикум за четврти разред гимназије",
...
html_title = 'SQL практикум за четврти разред гимназије'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='SQL практикум за четврти разред гимназије'
...
htmlhelp_basename = 'SQL_Praktikum-doc'
